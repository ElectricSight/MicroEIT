...
__author__ = "David Metz,Chang Liu,Jiawei Zhang,Xingyang Chen"
__copyright__ = "Copyright 2025, David Metz,Chang Liu,Jiawei Zhang,Xingyang Chen"
__credits__ = ["David Metz,Chang Liu,Jiawei Zhang,Xingyang Chen"]
__license__ = "GPL"
__version__ = "2.1.0"
__maintainer__ = "David Metz,Chang Liu,Jiawei Zhang,Xingyang Chen"
__email__ = "chang.liu@tu-braunschweig.de"
...
class UiBackEnd(QtWidgets.QMainWindow, eit_app.com_channels.AddUpdateUiAgent):
    ...
    def _set_actual_indexesforcomputation(self, imaging_type: str):
        ...
        ref_idx_value = self.ui.cB_eit_imaging_ref_frame.currentIndex()
    
            # 将 ref_idx 的值写入指定的文本文件
        file_path = "E:/Chen/EIT/eit_application/measurements/ref_idx.txt"  # 指定文本文件路径
        with open(file_path, "w") as f:
            f.write(str(ref_idx_value))  # 将 ref_idx 的值写入文本文件
